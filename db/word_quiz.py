...
# csv 파일의 내용을 테이블에 insert 하기(단, 테이블이 비어있는 경우에만 삽입)words = []
...
def seed_words_if_empty():
    '''words 테이블이 비어있으면 csv 파일 내용을 읽어서(load_words_from_csv()) 넣기'''
    if words 
    # insert
